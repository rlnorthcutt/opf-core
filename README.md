...
Diagnose installed packs: `scripts/pack-doctor.sh --owned-root <dir> --external-root <dir> [--native-root <dir>]` (add `--fix --yes` to apply the safe fixes once you've reviewed the report).
